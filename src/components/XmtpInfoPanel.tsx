...
const MetaMaskLogo = () => (
  <svg
    height="60"
    viewBox="-500 0 1311 242"
    width="324" // Made it bigger
...
const XmtpInfoPanel = ({ onConnect }: XmtpInfoPanelProps): JSX.Element => {
  ...
  return (
    ...
    <div className=" m-auto md:block ">
      <div className="flex flex-col items-center justify-center">
        {/* This div centers its children */}
        <MetaMaskLogo />
        <Button
          onClick={() => onConnect}
          className="mt-4 w-48 flex-col items-center justify-center rounded bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700"
        >
